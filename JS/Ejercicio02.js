...
nombrelUsuario = "diego.miguel@gmail.com";
passUsuario = "pas1234";
//En este momento de ejecución del sistema no sabemos su género, ni su estatus de relación sentimental.
console.log(`El usuario ${nombrelUsuario} esta intentando logearse con una contraseña: ${passUsuario}`);
...
console.log(`El usuario: ${nombrelUsuario}, se ha logeado exitosamente, al tener acceso a su información de perfil podemos deducir que es del genero ${generoUsuario} y que su estatus de relación es: ${estatusRelacionSentimental} y su última publicación la realizo el: ${fechaUltimoPost}`);
